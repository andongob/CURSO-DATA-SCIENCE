...
with open(r"Proyectos_clase\poema.txt", "r", encoding = "latin1") as file:
    poema = file.read()

file = open(r"Proyectos_clase\poema.txt", "r", encoding = "latin1")
poema = file.read()
file.close()
...
with open(r"Proyectos_clase\notas.txt", "w", encoding = "utf8") as file:
    file.write(texto)
...
with open(r"Proyectos_clase\notas.txt", "a", encoding = "utf8") as file:
    file.write(texto2)
...
try:
    with open(r"Proyectos_clase\inexistente.txt", "r", encoding = "latin1") as file:
        lista_poema = file.readlines()
...
import csv
try:
    with open(r"Proyectos_clase\alumnos.csv", "w") as archivo:
...
try:
    with open(r"Proyectos_clase\alumnos.csv", "a") as archivo:
        escritor_csv = csv.writer(archivo)
...
with open(r"Proyectos_clase\quijote.txt") as fichero:
...
try:
    with open(r"Proyectos_clase\clientes.csv", "w") as archivo:
        escritor_csv = csv.writer(archivo)
        escritor_csv.writerow(["Nombre", "Edad", "Email"])
        escritor_csv.writerow(["Ana", 28, "ana@mail.com"])
        escritor_csv.writerow(["Pedro", 35, "pedro@mail.com"])
...
with open(r"Proyectos_clase\clientes.csv") as archivo:
    lector_dict = csv.DictReader(archivo)
    for row in lector_dict:
        print(row)

with open(r"Proyectos_clase\clientes_filtrados.csv", "w", newline='') as csvfile_f:
    ...
    with open(r"Proyectos_clase\clientes.csv", newline='') as csvfile:
...
import pandas as pd
datos = pd.read_csv(r"Proyectos_clase\clientes.csv")
...
datos.to_csv(r"Proyectos_clase\clientes_filtrados2.csv")
...
contador_personajes(r"Proyectos_clase\quijote.txt")
