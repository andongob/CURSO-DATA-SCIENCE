...
22 % 2  # Devuelve el resto, caso de uso saber si el nº es par
# Potencia
2**2
3**2
# Raíz
...
#math es una librería por defecto
import math 
math.sqrt(25) 

from math import sqrt #otra manera de importar la librería
sqrt(25)

from math import sqrt as raiz #podemos utilizar un alias (raíz)
raiz(25)
...
12 < 3
# Devuelve True si ambos operandos son iguales (=asignación ==comparación)
12 == 3
...
del(j) #desaparece de la vista del explorador de variables
...
#como incrementar el valor de la variable
num = 7
num = num + 1
num += 5
