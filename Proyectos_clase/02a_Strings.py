...
# Cadenas de texto multilínea (hay que ejecutar todo el conjunto)
varias_lineas = """
Texto
en varias
líneas
"""
print(varias_lineas)
texto = "Hola\tmundo" #\t es una tabulación
print(texto)
del(texto)
...
#métodos devuelve booleano suelen empezar por is
saludo1.islower()
...
nombre_propio.find("toni") #muestra en qué posición está el primer caracter
...
"""si pones una f delante de cualquier string puedes poner 
la variable entre cochetes", es mu y común hacer esto"""
...
unidades = unidades.ljust(3, '0') #ljust: metodo que justifica por la izda
